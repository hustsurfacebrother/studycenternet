...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--task', default='multi_pose_kd',
        ...
        # system
        self.parser.add_argument('--gpus', default='1,3,5,7',
        ...
        self.parser.add_argument('--lr_step', type=str, default='100000,200000',
