...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='../images/10-1.jpg',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    #/home/wuxilab/dxx/CenterNet/exp/multi_pose/res_18_inp/model_best.pth
    self.parser.add_argument('--load_model', default='/home/wuxilab/dxx/CenterNet/exp/multi_pose/res_18_planer/model_best.pth',
