...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--demo', default='../images/10.png',
                             help='path to image/ image folders/ video. '
                                  'or "webcam"')
    self.parser.add_argument('--load_model', default='/home/wuxilab/dxx/CenterNet/exp/multi_pose/pretrained_16deconv_focal_all/model_best.pth',
    ...
    # model
    self.parser.add_argument('--arch', default='mobile_1',
    ...
    self.parser.add_argument('--lr_step', type=str, default='100,200',
                             help='drop learning rate by 10.')
    self.parser.add_argument('--num_epochs', type=int, default=300,
                             help='total training epochs.')
    self.parser.add_argument('--batch_size', type=int, default=64,
                             help='batch size')
    self.parser.add_argument('--master_batch_size', type=int, default=9,
